    ...
    for i1,myRef1 in [2,RefPublicReadsFound1[r1]],[1,RefLocalRepeatReadsFound1[r1]],[0,RefUniqueReadsFound1[r1]]:
        ...
        for f1 in treeFList1:
            ...
            for p1,j1 in enumerate(HeatMapTextFields0):
                ...
                fontsize3 = min(vclearance1,1.5*(xdel1-1.5)/(len(myValT1)+0.5))
                vtext(text=myValT1,xc=x11+xdel1/2,y1=y22-vclearance1,color=myTextColor1,font='dejavusans'+fontsize3)
                y22 -= vclearance1
