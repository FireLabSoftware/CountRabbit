...
RefCommonL1 =[]
for r1 in range(1,RefCount1+1):
    if RefUniqueReadsFound1[r1]+RefLocalRepeatReadsFound1[r1]*(not(AggregateUniqueAndLocalRepeats1))+RefPublicReadsFound1[r1]*(not(PrivateOnly1 or AggregateUniqueAndPublic1))>=MinCountsForDisplay1*SampleNum1:
...
## 03_10_24 ba07  Fixed a minor issue in the parsing of filenames